...
public class NumRemoteFragment extends Fragment { // use fragment not activity
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// SharedPreferences sp = getActivity().getSharedPreferences(PREFNAME,
		...
		// Fav_btn
		fav = (Button) view.findViewById(R.id.button7);
	...
	public void changechanal() {
		...
		changeCH.checkChanal(Ch);//เข้าฟังก์ชัน change channel on tv
	}
